...
/* Definição de timezone para usar a classe DateTime e manter compatibilidade com PHP 5.3 */
 ...
 */
if(file_exists(APP . 'Configs' . 'bootstrap.local.php'))
{
	include(APP . 'Configs' . 'bootstrap.local.php');
}
