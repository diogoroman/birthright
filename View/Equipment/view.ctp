...
<h2><?php  __('Materiais');?></h2>
	<dl><?php $i = 0; $class = ' class="altrow"';?>
		...
		<dd<?php if ($i++ % 2 == 0) echo $class;?>>
			<?php echo $equipment['0']['Equipment']['id']; ?>
			&nbsp;
		</dd>
		<dt<?php if ($i % 2 == 0) echo $class;?>><?php echo __('Ficha Carga'); ?></dt>
		<dd<?php if ($i++ % 2 == 0) echo $class;?>>
		...
		<dt<?php if ($i % 2 == 0) echo $class;?>><?php echo __('Classe'); ?></dt>
		<dd<?php if ($i++ % 2 == 0) echo $class;?>>
		...
		<dt<?php if ($i % 2 == 0) echo $class;?>><?php echo __('Descrição Sucinta'); ?></dt>
		<dd<?php if ($i++ % 2 == 0) echo $class;?>>
			<?php echo $equipment['0']['Equipment']['alias']; ?>
			&nbsp;
		</dd>
		<dt<?php if ($i % 2 == 0) echo $class;?>><?php echo __('Seção a que Pertence'); ?></dt>
		<dd<?php if ($i++ % 2 == 0) echo $class;?>>
			<?php echo $this->Html->link($equipment['0']['Owner']['acronym'], array('controller' => 'owners', 'action' => 'view', $equipment['0']['Owner']['id'])); ?>
			&nbsp;
		</dd>
		<dt<?php if ($i % 2 == 0) echo $class;?>><?php echo __('Preço Total'); ?></dt>
		<dd<?php if ($i++ % 2 == 0) echo $class;?>>
			<?php echo $equipment['0']['Equipment']['price']; ?>
			&nbsp;
		</dd>
		<dt<?php if ($i % 2 == 0) echo $class;?>><?php echo __('Unidade de Medida'); ?></dt>
		<dd<?php if ($i++ % 2 == 0) echo $class;?>>
			<?php echo $this->Html->link($equipment['0']['Measure']['name'], array('controller' => 'measures', 'action' => 'view', $equipment['0']['Measure']['id'])); ?>
			&nbsp;
		</dd>
		<dt<?php if ($i % 2 == 0) echo $class;?>><?php echo __('Quantidade'); ?></dt>
		<dd<?php if ($i++ % 2 == 0) echo $class;?>>
			<?php echo $equipment['0']['Equipment']['quantity']; ?>
			&nbsp;
		</dd>
		<dt<?php if ($i % 2 == 0) echo $class;?>><?php echo __('Inluido no Registro'); ?></dt>
		<dd<?php if ($i++ % 2 == 0) echo $class;?>>
...
<div class="related">
	...
	<tr>
		<th class="ui-widget-header"><?php echo __('Código Interno'); ?></th>
		<th class="ui-widget-header"><?php echo __('Patrimonio'); ?></th>
		<th class="ui-widget-header"><?php echo __('BMP'); ?></th>
		<th class="ui-widget-header"><?php echo __('Seção'); ?></th>
		<th class="ui-widget-header"><?php echo __('Sala'); ?></th>
		<th class="ui-widget-header"><?php echo __('Usuário'); ?></th>
		<th class="ui-widget-header"><?php echo __('Conferencia'); ?></th>
