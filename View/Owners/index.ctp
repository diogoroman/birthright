<div class="owners index">
	...
	<tr<?php echo $class;?>>
		...
		<td><?php echo $owner['Owner']['acronym']; ?>&nbsp;</td>
		<td><?php echo $this->Locale->dateTime($owner['Owner']['created']); ?>&nbsp;</td>
		<td><?php echo $this->Locale->dateTime($owner['Owner']['modified']); ?>&nbsp;</td>
		<td class="actions">
			<?php echo $this->Html->link(__('Ver', true), array('action' => 'view', $owner['Owner']['id']), array('class' => 'action-view')); ?>
			<?php echo $this->Html->link(__('Editar', true), array('action' => 'edit', $owner['Owner']['id']), array('class' => 'action-edit')); ?>
			<?php echo $this->Html->link(__('Excluir', true), array('action' => 'delete', $owner['Owner']['id']),array('class' => 'action-delete'), null, sprintf(__('Are you sure you want to delete # %s?', true), $owner['Owner']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
