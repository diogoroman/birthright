...
{
	if($patrimony['Patrimony']['patrimony_status_id'] == '3')
	{
		...
		$xpdf->MultiCell(40, 0, 'Estado', '', 'C', 0, 1);
	
		//$xpdf->Ln();
		$xpdf->MultiCell(20, 0, $patrimony['Patrimony']['id'], '', 'C', 0, 0);
		$xpdf->MultiCell(40, 0, $patrimony['Patrimony']['orderNum'], '', 'C', 0, 0);
		$xpdf->MultiCell(40, 0, $patrimony['Patrimony']['bmpNumber'], '', 'C', 0, 0);
		$xpdf->MultiCell(40, 0, $patrimony['PatrimonyStatus']['name'], '', 'C', 0, 1);
...
$xpdf->Output('ATI_AGUARDANDODESCARGA.pdf', 'I');
?>