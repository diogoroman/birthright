<div class="patrimonyStatuses index">
	...
	<tr<?php echo $class;?>>
		...
		<td><?php echo $this->Locale->dateTime($patrimonyStatus['PatrimonyStatus']['created']); ?>&nbsp;</td>
		<td><?php echo $this->Locale->dateTime($patrimonyStatus['PatrimonyStatus']['modified']); ?>&nbsp;</td>
		<td class="actions">
