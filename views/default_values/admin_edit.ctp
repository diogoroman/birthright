...
<?php echo $this->Form->create('DefaultValue');?>
	<fieldset>
 		<legend><?php __('Admin Edit Default Value'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Html->link(__('Delete', true), array('action' => 'delete', $this->Form->value('DefaultValue.id')), null, sprintf(__('Are you sure you want to delete # %s?', true), $this->Form->value('DefaultValue.id'))); ?></li>
