<div class="equipment index">
	...
	<tr>
			...
			<th class="ui-widget-header"><?php echo $this->Paginator->sort(__('Descrição', true),'description');?></th>
			<th class="ui-widget-header"><?php echo $this->Paginator->sort(__('Incluido no Registro', true),'includeRegister');?></th>
