...
<h2><?php  __('Equipment Type');?></h2>
	<dl><?php $i = 0; $class = ' class="altrow"';?>
		...
		<dd<?php if ($i++ % 2 == 0) echo $class;?>>
			<?php echo $equipmentType['EquipmentType']['name']; ?>
			&nbsp;
		</dd>
		<dt<?php if ($i % 2 == 0) echo $class;?>><?php __('Created'); ?></dt>
		<dd<?php if ($i++ % 2 == 0) echo $class;?>>
			<?php echo $equipmentType['EquipmentType']['created']; ?>
			&nbsp;
		</dd>
		<dt<?php if ($i % 2 == 0) echo $class;?>><?php __('Modified'); ?></dt>
		<dd<?php if ($i++ % 2 == 0) echo $class;?>>
			<?php echo $equipmentType['EquipmentType']['modified']; ?>
			&nbsp;
		</dd>
	</dl>
</div>
<div class="actions">
	...
	<ul>
		<li><?php echo $this->Html->link(__('Edit Equipment Type', true), array('action' => 'edit', $equipmentType['EquipmentType']['id'])); ?> </li>
		<li><?php echo $this->Html->link(__('Delete Equipment Type', true), array('action' => 'delete', $equipmentType['EquipmentType']['id']), null, sprintf(__('Are you sure you want to delete # %s?', true), $equipmentType['EquipmentType']['id'])); ?> </li>
		<li><?php echo $this->Html->link(__('List Equipment Types', true), array('action' => 'index')); ?> </li>
		<li><?php echo $this->Html->link(__('New Equipment Type', true), array('action' => 'add')); ?> </li>
...
<div class="related">
	...
	<?php if (!empty($equipmentType['Equipment'])):?>
	...
	<tr>
		...
		<th><?php __('Equipment Type Id'); ?></th>
	...
	<?php
		...
		<tr<?php echo $class;?>>
			...
			<td><?php echo $equipment['equipment_type_id'];?></td>
